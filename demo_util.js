...
Anklex=poses[0].pose.keypoints[16].position.x
Ankley=poses[0].pose.keypoints[16].position.y
Leftsx=poses[0].pose.keypoints[5].position.x
Rightsx=poses[0].pose.keypoints[6].position.x
LeftElbx=poses[0].pose.keypoints[7].position.x
RightElbx=poses[0].pose.keypoints[8].position.x
Leftsy=poses[0].pose.keypoints[5].position.y
Rightsy=poses[0].pose.keypoints[6].position.y
LeftElby=poses[0].pose.keypoints[7].position.y
RightElby=poses[0].pose.keypoints[8].position.y*/
